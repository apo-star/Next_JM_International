...
export const featuredProdcuts = [
  {
    id: 1,
    section: "Eje de mando",
    sectionES: "Drive shaft",
    products: [
      {
        id: 1,
        name: "Quantum Trux Parts",
  ...
  {
    id: 4,
    section: "Partes electricas",
    sectionES: "Electrical parts",
    products: [
      {
        id: 1,
        name: "Quantum Trux Parts",
  ...
  {
    id: 5,
    section: "Accesorios para puertas y espejos",
    sectionES: "Accessories for doors and mirrors",
    products: [
      {
        id: 1,
        name: "Quantum Trux Parts",
  ...
  {
    id: 9,
    section: "Componentes de direccion",
  ...
  {
    id: 10,
    section: "Tanques de reserva",
    sectionES: "Radiadores (surge tanks and radiators",
    products: [
      {
        id: 1,
        name: "Quantum Trux Parts",
  ...
  {
    id: 11,
    section: "Lamparas y escoltas",
    sectionES: "Lamps and strobe lights",
    products: [
      {
        id: 1,
        name: "Quantum Trux Parts",
